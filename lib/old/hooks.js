...
import { createElement as $, useEffect, useRef, useState } from "react"
import { getDisplayName, setDisplayName, wrapDisplayName } from "recompose"

import { different, same, stubArray } from "./immutables"
...
export function renderComponent(Component) {
  return (props) => props[IGNORE] ? props : { ...props, [IGNORE]: $(Component, props) }
}

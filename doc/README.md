...
- [ResizeEffectOptions](README.md#resizeeffectoptions)
...
- [useResizeEffect](README.md#useresizeeffect)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `box?` | `ResizeObserverBoxOptions` | Sets which box model the observer will observe changes to. |
| `parents?` | `boolean` | Whether parents should be observed as well. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `element` | `undefined` \| ``null`` \| ``false`` \| `Element` | `undefined` | The element on which to observe resize events. |
| `callback` | `ResizeObserverCallback` | `undefined` | The callback called by the observer with the mutation list and the observer. |
| `options` | [`ResizeEffectOptions`](README.md#resizeeffectoptions) | `EMPTY_OBJECT` | Observation options. |
